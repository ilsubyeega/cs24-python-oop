...
class Bank:
    # instead of just appending a location property in account.py, let's just saving here at this moment.
    _location = {}
    ...
    def createAccount(self, theName, theStartingAmount, thePassword, location):
        ...
        self._location[newAccountNumber] = location
    ...
    def show(self):
        ...
        for userAccountNumber in self.accountsDict:
            ...
            print('   Account location:', self._location[userAccountNumber])
            oAccount.show()
