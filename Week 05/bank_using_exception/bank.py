...
class Bank():
    ...
    def createAccount(self, theName, theStartingAmount, thePassword, location):
        oAccount = Account(theName, theStartingAmount, thePassword, location)
    ...
    def openAccount(self):
        ...
        userLocation = input('Please input the location where you are in now: ')
        userAccountNumber = self.createAccount(userName, userStartingAmount, userPassword, userLocation)
