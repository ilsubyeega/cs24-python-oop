...
def assert_triangle_type(triangle):
    assert isinstance(triangle, Triangle), 'Not a Triangle object'
...
class Triangle:
    ...
    # if this triangle and then arg triangle have the same area. Not meant for same triangle.
    # Since it's not a same position of it.
    def __eq__(self, other):
        assert_triangle_type(other)
