...
# homework: create faction 7, 8.
    oFraction7 = Fraction(1, 12)
    oFraction8 = Fraction(1, 64)
    print('Sum of 1/12 and 1/64\n', oFraction7 + oFraction8)
    print('EQ ^?:', oFraction7 == oFraction8)
    print('TLDR: 3 * 64 =', 3 * 64)