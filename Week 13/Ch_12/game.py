...
class Game:
    ...
    def __init__(self, window):
        ...
        self.messageText = pygwidgets.DisplayText(window, (50, 120),
    ...
    def reset(self):  # this method is called when a new round starts
        ...
        for cardIndex in range(0, Game.NCARDS):  # deal out cards
            ...
            # homework: repositionize with 2nd line
            thisXPosition = self.cardXPositionsList[cardIndex % 8]
            thisYPosition = Game.CARDS_TOP if cardIndex < 8 else Game.CARDS_TOP + 120
    ...
    def hitHigherOrLower(self, higherOrLower):
        ...
        done = done or (self.score < 0) # did we run out of points?
        return done
